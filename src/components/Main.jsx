      ...
      <aside className="flex flex-row">
        ...
        <div className="sm:w-[50%] h-full sm:px-10 sm:py-12 px-5 py-7">
          ...
          <div className="text-4xl flex items-center mt-2 font-medium">
            <p className="hidden mmd:block mmd:w-[6rem] mmmd:w-[6.7rem] h-[2px] bg-[#C6AF84] rounded-full"></p>
            <h3 className="mmd:ml-2 mmmd:ml-8 mmmmd:ml-14">Developer 🔮</h3>
          </div>
          ...
          <a href={Resume} target="_blank" rel="noopener noreferrer">
            <button className="flex text-sm justify-center items-center mt-4 border-b-[1.5px] border-transparent hover:border-b-[#1f1f1f] font-medium transition-colors duration-300 hover:opacity-80">
        ...
        <div className="relative md:-ml-10 lg:-ml-12 hidden sm:flex sm:w-[50%] sm:flex-col justify-around items-center">
          <img
            className="w-[285px] h-[400px] z-50 rounded-full"
            src={Me}
            alt="Tharunprasath"
          />
          <img
      ...
      <aside className="flex items-center justify-between px-5 sm:px-10">
        ...
        <div className="flex justify-around items-center">
          <a
            ...
            rel="noreferrer"
          >
            <EnvelopeClosedIcon className="sm:text-[#fefde9] hover:opacity-50 mr-6 w-6 h-6 transition-all duration-300 cursor-pointer" />
          </a>
          <a
            ...
            rel="noreferrer"
          >
            <GitHubLogoIcon className="sm:text-[#fefde9] hover:opacity-50 mr-6 w-6 h-6 transition-all duration-300 cursor-pointer" />
          </a>
          <a
            ...
            rel="noreferrer"
          >
            <LinkedInLogoIcon className="sm:text-[#fefde9] hover:opacity-50 w-6 h-6 transition-all duration-300 cursor-pointer" />
          </a>
        </div>
      </aside>
    </section>
